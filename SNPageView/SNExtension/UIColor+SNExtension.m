...
+ (UIColor*) sn_colorWithHex:(NSUInteger)hex
{
    ...
    return [UIColor sn_colorWithRed255:red green255:green blue255:blue alpha:1];
}
...
+ (UIColor*) sn_colorWithAlphaHex:(NSUInteger)hex
{
    ...
    return [UIColor sn_colorWithRed255:red green255:green blue255:blue alpha:alpha/255];
}
...
+(UIColor*) sn_colorWithHexString:(NSString*)string16
{
    ...
    if (color16.length > 6) {
        return [UIColor sn_colorWithAlphaHex:hex];
    }
    else {
        return [UIColor sn_colorWithHex:hex];
    }
}
